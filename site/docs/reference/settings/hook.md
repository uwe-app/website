...
The `[hook.run]` table is used to define command hooks; see [[docs/other/hooks]] for more detail.
...
* `profiles` Execute only for the given build [[docs/other/profiles]] (optional)
